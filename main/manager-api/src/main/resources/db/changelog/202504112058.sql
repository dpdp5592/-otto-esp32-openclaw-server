...
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (400, 'plugins.get_weather.api_key', 'YOUR_QWEATHER_API_KEY', 'string', 1, '天气插件API密钥');
